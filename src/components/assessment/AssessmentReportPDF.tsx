    ...
    return (
        <Document title={`${userName} — Cadence Assessment Report`} author="Cadence">
            ...
            <Page size="A4" style={s.page}>
                ...
                <View style={[s.transcriptBox, { marginBottom: 12 }]}>
                    <Text style={s.subHeading}>About This Report</Text>
                    <Text style={{ fontSize: 7.8, color: '#4A5568', lineHeight: 1.45, marginBottom: 5 }}>
                        Cadence operates on a diagnostic rather than purely evaluative philosophy. This report identifies what occurred during speech delivery, where specific patterns appeared in the recording, and what targeted drills to practice. The numeric scores are a byproduct of this diagnosis, not the primary output.
                    </Text>
                    <Text style={{ fontSize: 7.8, color: '#4A5568', lineHeight: 1.45, marginBottom: 5 }}>
                        Analysis evaluates five independent axes: Fluency & Rhythm, Pronunciation & MTI, Prosody & Intonation, Stutter & Disfluency, and Vocabulary & Grammar. These dimensions are scored separately on purpose—an MTI pronunciation pattern and an unrelated stutter call for fundamentally different practice regimens, even though conventional evaluations often conflate them into a single score.
                    </Text>
                    <Text style={{ fontSize: 7.8, color: '#4A5568', lineHeight: 1.45 }}>
                        The six dashboard scores are computed deterministically from audio-derived metrics (precise millisecond word timing, acoustic pause analysis, and phonemic/WER alignment against the reference passage)—never estimated or generated by an LLM. The AI's role is strictly confined to qualitative explanations, contextual insights, and coaching guidance.
                    </Text>
                </View>

                <Text style={s.subHeading}>Score Interpretation</Text>
                <Text style={{ fontSize: 7.5, color: '#718096', marginBottom: 6 }}>All scores are on a scale of 0–100.</Text>
            ...
            <Page size="A4" style={s.page}>
                <SectionHeading>Score Dashboard</SectionHeading>

                {/* Score tiles */}
                <Text style={s.subHeading}>Core Competency Scores</Text>
            ...
            <Page size="A4" style={s.page}>
                ...
                {sentences.length > 0 ? sentences.map((sentence: any, idx: number) => (
                    <View key={idx} style={s.sentenceCard} wrap={false}>
            ...
            {/* ══════════════════════ PAGE 9: 3-Week Plan ══════════════════════ */}
            {/* removed from PDF per 2026-09-06 decision — see CHANGELOG
            <Page size="A4" style={s.page}>
